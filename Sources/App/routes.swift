...
public func routes(_ router: Router) throws {
    ...
    router.get("staff", use: handleStaffPage)
    router.get("staff", String.parameter, use: handleStaffPage)
...
func handleStaffPage(_ req: Request) throws -> Future<View> {
    let name = (try? req.parameters.next(String.self)) ?? "notProvided"
